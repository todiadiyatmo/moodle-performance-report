...
Please note that this measure does not improve performance of the server significantly, though it may slow down or limit general exploits.</p>';
...
$string['eventreportviewed'] = 'Viewed performance check report';
$string['issue'] = 'Issue';
$string['pluginname'] = 'Performance Report';
$string['tonjoo:view'] = 'View performance report';
...
$string['setting_enable_desc']  = 'Enable to activate performance Plugin';
$string['home'] = 'Performance Student';
